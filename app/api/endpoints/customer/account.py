...
def get_bought(
    ...
    try:
        ...
        bought_posts = []
        for post, profile_name, offical_flg, username, avatar_url, thumbnail_key, duration_sec, likes_count, comments_count, purchased_at, plan_name in bought_posts_data:
            # 動画時間をフォーマット
            duration = None
            if duration_sec:
                minutes = int(duration_sec // 60)
