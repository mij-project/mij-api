...
def create_notification_admin(db: Session, notification: NotificationCreateRequest) -> Notifications:
  """
  管理者用の通知を作成
  """
  try:
...
def update_notification_admin(db: Session, notification_id: UUID, notification_update: NotificationCreateRequest) -> Notifications:
  """
  管理者用の通知を更新
  """
  try:
...
def __mark_notification_as_read_users(db: Session, notification_id: UUID, user_id: UUID) -> bool:
  """
...
def __mark_notification_as_read_payments(db: Session, notification_id: UUID, user_id: UUID) -> bool:
  """
