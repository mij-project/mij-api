...
def trigger_batch_notification_newpost_arrival(post_id: str, creator_user_id: str):
    """
    新着投稿通知をトリガーする
    """
    try:
        ...
        run_ecs_task(
            ...
            task_definition=os.environ.get(
                "ECS_NOTIFICATION_NEWPOST_ARRIVAL_TASK_DEFINITION"
            ),
            launch_type="FARGATE",
            overrides={
                "containerOverrides": [
                    {
                        ...
                        "environment": [
                            ...
                            {"name": "CREATOR_USER_ID", "value": creator_user_id},
                            {
                                "name": "FRONTEND_URL",
                            ...
                            {
                                "name": "CDN_BASE_URL",
                                "value": os.environ.get("CDN_BASE_URL"),
                            },
                        ],
                    }
                ]
